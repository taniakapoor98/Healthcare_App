...
with col1:
    ...
    if st.button("Analyze"):
        ...
        medical_prompt = ChatPromptTemplate.from_template(MEDICAL_PROMPT_TEMPLATE) | ChatOpenAI(model="gpt-4",
...
with col2:
    ...
    if user_input:
        ...
        with st.spinner("Analyzing your health report..."):
            qa_chain = ChatPromptTemplate.from_template(PROMPT_TEMPLATE) | ChatOpenAI(model="gpt-4",
                                                                                      openai_api_key=openai_api_key,
                                                                                      max_tokens=1024)
